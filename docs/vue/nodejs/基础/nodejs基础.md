...
[ (opens new window)](https://nodejs.org/en/)
...
- 基于 [Express 框架](http://www.expressjs.com.cn/)

[ ](http://www.expressjs.com.cn/)

[ (opens new window)](http://www.expressjs.com.cn/)，可以快速构建 Web 应用

基于 [Electron 框架](https://electronjs.org/)

[ ](https://electronjs.org/)

[ (opens new window)](https://electronjs.org/)，可以构建跨平台的桌面应用

基于 [restify 框架](http://restify.com/)

[ ](http://restify.com/)

- [ (opens new window)](http://restify.com/)，可以快速构建 API 接口项目
...
> [ (opens new window)](http://nodejs.cn/api/buffer.html)
...
#### [#](https://brucecai55520.gitee.io/bruceblog/notes/nodejs/node.html#流式文件写入) 流式文件写入
